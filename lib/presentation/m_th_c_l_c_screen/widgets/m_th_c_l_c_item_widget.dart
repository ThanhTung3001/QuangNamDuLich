...
import '../models/m_th_c_l_c_item_model.dart';
import 'package:flutter/material.dart';
import 'package:quang_nam_travel/core/app_export.dart';

// ignore: must_be_immutable
class MThCLCItemWidget extends StatelessWidget {
  MThCLCItemWidget(this.mThCLCItemModelObj);

  MThCLCItemModel mThCLCItemModelObj;

  var controller = Get.find<MThCLCController>();
