...
import '../models/gi_i_tr_item_model.dart';
import 'package:flutter/material.dart';
import 'package:quang_nam_travel/core/app_export.dart';

// ignore: must_be_immutable
class GiITrItemWidget extends StatelessWidget {
  GiITrItemWidget(this.giITrItemModelObj);

  GiITrItemModel giITrItemModelObj;

  var controller = Get.find<GiITrController>();
