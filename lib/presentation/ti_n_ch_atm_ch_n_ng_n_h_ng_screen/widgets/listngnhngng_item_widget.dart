...
import '../models/listngnhngng_item_model.dart';
...
class ListngnhngngItemWidget extends StatelessWidget {
  ListngnhngngItemWidget(this.listngnhngngItemModelObj);

  ListngnhngngItemModel listngnhngngItemModelObj;

  var controller = Get.find<TiNChAtmChNNgNHNgController>();
