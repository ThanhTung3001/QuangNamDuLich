...
import '../models/listcahngxngd_item_model.dart';
...
class ListcahngxngdItemWidget extends StatelessWidget {
  ListcahngxngdItemWidget(this.listcahngxngdItemModelObj);

  ListcahngxngdItemModel listcahngxngdItemModelObj;

  var controller = Get.find<TiNChXNgDUController>();
