...
import '../models/mua_s_m_item_model.dart';
import 'package:flutter/material.dart';
import 'package:quang_nam_travel/core/app_export.dart';

// ignore: must_be_immutable
class MuaSMItemWidget extends StatelessWidget {
  MuaSMItemWidget(this.muaSMItemModelObj);

  MuaSMItemModel muaSMItemModelObj;

  var controller = Get.find<MuaSMController>();
