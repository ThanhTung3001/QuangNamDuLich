...
import '../models/listxedulchtuy_item_model.dart';
...
class ListxedulchtuyItemWidget extends StatelessWidget {
  ListxedulchtuyItemWidget(this.listxedulchtuyItemModelObj);

  ListxedulchtuyItemModel listxedulchtuyItemModelObj;

  var controller = Get.find<TiNChDiChuyNChiTiTController>();
