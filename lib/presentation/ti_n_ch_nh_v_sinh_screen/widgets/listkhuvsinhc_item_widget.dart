...
import '../models/listkhuvsinhc_item_model.dart';
...
class ListkhuvsinhcItemWidget extends StatelessWidget {
  ListkhuvsinhcItemWidget(this.listkhuvsinhcItemModelObj);

  ListkhuvsinhcItemModel listkhuvsinhcItemModelObj;

  var controller = Get.find<TiNChNhVSinhController>();
