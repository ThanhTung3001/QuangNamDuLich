...
import '../models/l_u_tr_l_c_item_model.dart';
import 'package:flutter/material.dart';
import 'package:quang_nam_travel/core/app_export.dart';

// ignore: must_be_immutable
class LUTrLCItemWidget extends StatelessWidget {
  LUTrLCItemWidget(this.lUTrLCItemModelObj);

  LUTrLCItemModel lUTrLCItemModelObj;

  var controller = Get.find<LUTrLCController>();
