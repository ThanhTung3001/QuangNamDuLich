...
class ListqungingItemWidget extends StatelessWidget {
  ListqungingItemWidget(this.listqungingItemModelObj);

  ListqungingItemModel listqungingItemModelObj;

  var controller = Get.find<CCAIMLUOneController>();
